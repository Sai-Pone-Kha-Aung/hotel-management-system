...
public class checkOut extends JFrame {
	...
	public checkOut() {
		...
		scrollPane.setBounds(18, 271, 760, 280);
		...
		btnBack.setIcon(new ImageIcon(checkOut.class.getResource("/Images/backwhite.png")));
		...
		btnClose.setIcon(new ImageIcon(checkOut.class.getResource("/Images/close.png")));
		...
		lblNewLabel.setBounds(225, 65, 99, 16);
		contentPane.add(lblNewLabel);
		
		JButton btnSearch = new JButton("");
		btnSearch.setBorderPainted(false);
		btnSearch.setIcon(new ImageIcon(checkOut.class.getResource("/Images/searchbtn.png")));
		...
		btnSearch.setBounds(478, 65, 70, 20);
		...
		lblNewLabel_1_1.setBounds(225, 97, 130, 16);
		...
		lblNewLabel_1_2.setBounds(420, 97, 153, 16);
		...
		lblNewLabel_1_3.setBounds(609, 97, 171, 16);
		...
		lblNewLabel_1_4.setBounds(22, 165, 169, 16);
		...
		lblNewLabel_1_1_1.setBounds(225, 165, 169, 16);
		...
		lblNewLabel_1_2_1.setBounds(420, 165, 169, 16);
		...
		lblNewLabel_1_3_1.setBounds(609, 165, 171, 16);
		...
		btnNewButton.setIcon(new ImageIcon(checkOut.class.getResource("/Images/checkoutbtn1.png")));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Query = "update users set status='Not Booked', roomNo=NULL, roomType=NULL  where email='"+email+"' ";
				InsertUpdateDelete.setData(Query, "");
		...
		btnNewButton.setBounds(18, 238, 117, 20);
		contentPane.add(btnNewButton);
		
		JButton btnClear = new JButton("");
		btnClear.setIcon(new ImageIcon(checkOut.class.getResource("/Images/clearbtn1.png")));
		...
		btnClear.setBounds(147, 238, 117, 20);
		contentPane.add(btnClear);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setForeground(Color.WHITE);
		lblNewLabel_2.setBackground(Color.WHITE);
		lblNewLabel_2.setIcon(new ImageIcon(checkOut.class.getResource("/Images/admincheckout.png")));
